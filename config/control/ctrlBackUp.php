...
class Backup_Database
{
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8')
    {
        ...
        $this->backupFile              = 'backup-' . $this->dbName . '-' . date("Y-m-d") . '.sql';
    ...
    public function backupTables($tables = '*')
    {
        try {
            ...
            if ($this->gzipBackupFile) {
                ...
                $this->obfPrint('<div style="color: green; font-size: 16px;">Backup realizado correctamente en la siguiente dirección: <b>' . $this->backupDir . '/' . $this->backupFile . '</b></div> ', 1, 1);
            }
        } catch (Exception $e) {
            print_r($e->getMessage());
            return false;
